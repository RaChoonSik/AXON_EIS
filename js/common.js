    ...
    return {
        ...
        conthead : function(){
            $(document).on("click", ".cont-head .btn-fold", function(){
                ...
                if($(".btn-board").closest(".drop-tg").hasClass("open")){ //게시판클릭
                    popGetTopBoardList( ); //게시판 목록 조회 /inc/top.jsp
        ...
        toggle : function(){
            $(document).on("click", ".toggle .btn-toggle", function(){
                ...
                /* 신성재 추가 S */
                var cls = $(this).closest("div.nav-menu").attr( "class" );
                if( cls == "nav-menu depth menu-list" ){
                    fn_setSessionRptSubMenuHtml();
                }
                /* 신성재 추가 E */
            });
